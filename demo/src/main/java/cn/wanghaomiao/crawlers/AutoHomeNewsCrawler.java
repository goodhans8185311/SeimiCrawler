 ...
 * @since 2016/6/14.
 */
@Crawler(name = "autohomenews")
public class AutoHomeNewsCrawler extends BaseSeimiCrawler {
    @Override
    public String[] startUrls() {
        return new String[]{"http://www.autohome.com.cn/news/201702/898879.html#pvareaid=102624"};
    }
...
//            System.out.println("body = " + preBody);
